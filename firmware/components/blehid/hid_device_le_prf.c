...
static const esp_gatts_attr_db_t bas_att_db[BAS_IDX_NB] = {
    ...
    [BAS_IDX_SVC] = {{ESP_GATT_AUTO_RSP},
                     {ESP_UUID_LEN_16, (uint8_t *)&primary_service_uuid,
                      ESP_GATT_PERM_READ, sizeof(uint16_t), sizeof(battary_svc),
                      (uint8_t *)&battary_svc}},
...
static esp_gatts_attr_db_t hidd_le_gatt_db[HIDD_LE_IDX_NB] = {
    ...
    [HIDD_LE_IDX_HID_INFO_VAL] = {{ESP_GATT_AUTO_RSP},
                                  {ESP_UUID_LEN_16,
                                   ...
                                   ESP_GATT_PERM_READ, sizeof(hids_hid_info_t),
                                   sizeof(hidInfo), (uint8_t *)&hidInfo}},
    ...
    [HIDD_LE_IDX_HID_CTNL_PT_VAL] = {{ESP_GATT_AUTO_RSP},
                                     {ESP_UUID_LEN_16,
                                      ...
                                      ESP_GATT_PERM_WRITE, sizeof(uint8_t), 0,
                                      NULL}},
    ...
    [HIDD_LE_IDX_REPORT_VAL] = {{ESP_GATT_AUTO_RSP},
                                {ESP_UUID_LEN_16, (uint8_t *)&hid_report_uuid,
                                 ESP_GATT_PERM_READ, HIDD_LE_REPORT_MAX_LEN, 0,
                                 NULL}},
    // Report Characteristic - Report Reference Descriptor
...
void esp_hidd_prf_cb_hdl(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if,
...
#if (SUPPORT_REPORT_VENDOR == true)
    if (param->write.handle ==
            hidd_le_env.hidd_inst.att_tbl[HIDD_LE_IDX_REPORT_VENDOR_OUT_VAL] &&
      ...
      (hidd_le_env.hidd_cb)(ESP_HIDD_EVENT_BLE_VENDOR_REPORT_WRITE_EVT,
                            &cb_param);
    }
#endif
    break;
  ...
  case ESP_GATTS_CREAT_ATTR_TAB_EVT: {
    if (param->add_attr_tab.num_handle == BAS_IDX_NB &&
      ...
      esp_ble_gatts_create_attr_tab(hidd_le_gatt_db, gatts_if, HIDD_LE_IDX_NB,
                                    0);
    }
